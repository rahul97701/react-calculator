...
export class DigitalCalculator extends React.Component {
            ...
            <div className="row justify-content-center">
              <div className="col-md-5">
                ...
                <div className="app-header">
                    <span className="app-title">RK</span> Calculator 
                ...
                <p className="copy-right text-right">
                    &copy; 2020, <a href="https://github.com/rahul97701/react-calculator" target="_blank">Rahuul Khiichi </a>
                </p>
            </div>
            </div>
        </div>
